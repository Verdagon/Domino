    ...
    public static MemberToViewMapper MakeVivimap() {
      ...
      entries.Add("Rocks", new List<MemberToViewMapper.IDescription>() {
        new MemberToViewMapper.OverlayDescriptionForIDescription(
          new ExtrudedSymbolDescription(
            RenderPriority.TILE,
            new SymbolDescription(new SymbolId("AthSymbols", 0x0066), Vector4Animation.Color(.5f, .5f, .5f, .2f), 0, 1, OutlineMode.WithOutline),
            false,
      ...
      entries.Add("Obsidian", new List<MemberToViewMapper.IDescription>() {
        new MemberToViewMapper.OverlayDescriptionForIDescription(
          new ExtrudedSymbolDescription(
            RenderPriority.TILE,
            new SymbolDescription(new SymbolId("AthSymbols", 0x0066), Vector4Animation.Color(0f, 0f, 0f, .8f), 0, 1, OutlineMode.WithOutline),
            false,
            Vector4Animation.BLACK))
      });
      ...
      entries.Add("ManaPotion", new List<MemberToViewMapper.IDescription>() {
        new MemberToViewMapper.ItemDescriptionForIDescription(
          new ExtrudedSymbolDescription(
              RenderPriority.SYMBOL,
              new SymbolDescription(
                  new SymbolId("AthSymbols", 0x002C),
      ...
      entries.Add("Cave", new List<MemberToViewMapper.IDescription>() {
        new MemberToViewMapper.FeatureDescriptionForIDescription(
            new ExtrudedSymbolDescription(
                RenderPriority.SYMBOL,
                new SymbolDescription(
                    new SymbolId("AthSymbols", 0x0070),
                    Vector4Animation.BLACK,
                    0,
                    1,
      ...
      entries.Add("Tree", new List<MemberToViewMapper.IDescription>() {
        new MemberToViewMapper.FeatureDescriptionForIDescription(
            new ExtrudedSymbolDescription(
                RenderPriority.SYMBOL,
                new SymbolDescription(
                    new SymbolId("AthSymbols", 0x006E),
      ...
      entries.Add("Magma", new List<MemberToViewMapper.IDescription>() {
        ...
        new MemberToViewMapper.OverlayDescriptionForIDescription(
          new ExtrudedSymbolDescription(
              RenderPriority.SYMBOL,
              new SymbolDescription(
                  new SymbolId("AthSymbols", 0x0066),
      ...
      entries.Add("Trigger", new List<MemberToViewMapper.IDescription>() {
        new MemberToViewMapper.ItemDescriptionForIDescription(
          new ExtrudedSymbolDescription(
            RenderPriority.TILE,
            new SymbolDescription(new SymbolId("AthSymbols", 0x0065), Vector4Animation.Color(1f, 1f, 1f, 0.2f), 180, 1, OutlineMode.NoOutline, Vector4Animation.Color(1, 1, 1)),
            true,
      ...
      entries.Add("Marker", new List<MemberToViewMapper.IDescription>() {
        new MemberToViewMapper.ItemDescriptionForIDescription(
          new ExtrudedSymbolDescription(
            RenderPriority.TILE,
            new SymbolDescription(
                new SymbolId("AthSymbols", 0x0065), Vector4Animation.Color(1f, .75f, .5f, 1.2f), 0, 1, OutlineMode.WithOutline),
            false,
            Vector4Animation.BLACK))
      });
      entries.Add("Avelisk", new List<MemberToViewMapper.IDescription>() {
          ...
          new MemberToViewMapper.FaceDescriptionForIDescription(
              new ExtrudedSymbolDescription(
                  RenderPriority.SYMBOL,
                  new SymbolDescription(
                      new SymbolId("AthSymbols", 0x0078),
      ...
      entries.Add("Zeddy", new List<MemberToViewMapper.IDescription>() {
          new MemberToViewMapper.DetailDescriptionForIDescription(
              new ExtrudedSymbolDescription(
                  RenderPriority.SYMBOL,
                  new SymbolDescription(
                      new SymbolId("AthSymbols", 0x0075),
                      Vector4Animation.Color(1, 1, 1, 1f), 0, 1, OutlineMode.WithBackOutline),
                  false, Vector4Animation.Color(0, 0, 0)))
      });
